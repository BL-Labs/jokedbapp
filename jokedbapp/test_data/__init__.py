...
<a>Fun.</a> </j>"""),
           ("""<j> <t>THAT APPLE AGAIN.</t> - Jack: Look here, Winny!- an apple weighing thirty-two ounces. - Winny: Dear me! It must have been the dying effort of the tree. <a>Judy</a> </j>
...
<j> <t>NOT SO BAD AFTER ALL.</t> - Mrs McFadden: I'm very queer again, doctor. My cough bothers me so: I'm afraid I'm going to die. - Genial Medical Person: Never mind, it's not a very difficult thing to do. The last year of our life is much easier than the first. You see, there's no teething. <a>Judy</a> </j>""")]

JOKES = [("""PRESSING.""", """ - Mr. Truelove: Now I'll go. I'm afraid I've taken up too much your time already.
 - Lady Novelist: I'm so glad to have seen you. I'm busy now with the opening chapters of my next three-volume novel. You must come again when I've finished it.""", """Judy"""),
         ("[Untitled]", """"Bark," a colour resembling the sails of fishing boats, is the fashionable tint for autumn. 
With a favourable breeze no doubt the bark will have a good sail.""", "Moonshine"),
         ("""Why Mr. Parnell Will "Go" If He Does "Go." """, """ - For "divorce" reasons, to be sure.""", "Funny Folks"),
         ("ALL RIGHT NOW.", """ - Well, how is your little boy, mrs. Wiggles? - Oh, much better now, mum. I took him to the doctor, who said it was only a rash broke out all over his body, and he gave him some medicine to putrify his blood.""", "Judy"),
         ("A ROUNDABOUT ROLE.", " - A rigmarole. ", "Funny Folks"),
         ("RUS IN URBE.", """ Old Lady (from the country, as train is nearing Cannon-street): It is wonderful 'ow they knows which line to go on; 'an all so much alike. But (brightening) - I suppose they 'as a compass. """ ,"Judy"),]
